...
# $Header: /var/cvsroot/gentoo/src/catalyst/livecd/runscript-support/Attic/livecdfs-update.sh,v 1.35.2.20 2005/07/14 18:20:56 wolf31o2 Exp $
...
then
	...
	sed -i 's/##STARTX/su - ${first_user} -c "source /etc/profile && startx"/' \
		/root/.bashrc
fi
