...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="left" valign="top" height="125"><table width="100%" height="125"  border="0" cellpadding="0" cellspacing="0" background="{GLSR_URL}_template/{THEME}/images/header-bk.png">
      <tr>
        <td><img src="{GLSR_URL}_template/{THEME}/images/glogo.png" width="193" height="125"><img src="{GLSR_URL}_template/{THEME}/images/splogo-beta.png" width="350" height="125"></td>
      </tr>
    </table></td>
  </tr>
  <tr>
