...
"""
		...
		hbox.pack_start(gtk.Label("The entire system will be compiled from scratch with your CHOST and CFLAGS settings"), expand=False, fill=False, padding=20)
