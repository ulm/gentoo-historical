...
"""
		...
		hbox.pack_start(gtk.Label("This bootloader isn't as flexible as grub, but some people still prefer it"), expand=False, fill=False, padding=20)
		vert.pack_start(hbox, expand=False, fill=False, padding=20)
		...
		hbox.pack_start(gtk.Label("Choose this if you don't want a bootloader installed"), expand=False, fill=False, padding=20)
		vert.pack_start(hbox, expand=False, fill=False, padding=20)
		...
		hbox.pack_start(gtk.Label("This controls whether the bootloader is installed in the MBR or not"), expand=False, fill=False, padding=20)
		vert.pack_start(hbox, expand=False, fill=False, padding=20)
