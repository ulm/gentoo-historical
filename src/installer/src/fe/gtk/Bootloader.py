...
"""
		...
		self.boot_loaders['grub'].set_size_request(140, -1)
		...
		self.boot_loaders['lilo'].set_size_request(140, -1)
		hbox = gtk.HBox(False, 0)
		...
		self.boot_loaders['none'].set_size_request(140, -1)
		hbox = gtk.HBox(False, 0)
		...
		self.check_install_in_mbr.set_size_request(140, -1)
		hbox = gtk.HBox(False, 0)
