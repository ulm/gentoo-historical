...
$Id: GLIArchitectureTemplate.py,v 1.103 2005/04/29 16:27:19 agaffney Exp $
...
class ArchitectureTemplate:
	...
	def _quickpkg_deps(self, package):
		...
		packages = GLIUtility.spawn("emerge -p " + package + r" | grep -e '\[ebuild' | sed -e 's:\[ebuild .\+ \] ::' -e 's: \[.\+\] ::' -e 's: +$::'", chroot=self._chroot_dir, return_output=True)[1].split("\n")
		for pkg in packages:
