...
subarches=["amd64", "hppa", "hppa1.1", "hppa2.0", "px86", "i386", "i486", "i586", "i686",
...
def compile_defaults(subarch):
	...
	if subarch == "ia64":
		...
		if subarch in ["i386","i486","i586"]:
			...
			results=["x86",cf,"i686-pc-linux-gnu"]
