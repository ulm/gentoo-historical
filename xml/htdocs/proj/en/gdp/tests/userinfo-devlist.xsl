...
<xsl:variable name="devaway" select='document("http://dev.gentoo.org/~neysx/devaway.php")'/>
  ...
  <mainpage id="about">
	...
	<body>
	  <p>
		...
		on the <uri link="/proj/en/gdp/tests/userinfo.xml">Gentoo Linux Developer List</uri>.
	      </xsl:when>
	    </xsl:choose>
	  </p>
