...
<!--content end-->
			...
			<td width="1%" bgcolor="#dddaec" valign="top">
				...
				<td align="center" class="alttext">
					Mis à jour le <xsl:value-of select="/guide/date"/>
				</td>
				</tr>
				<tr>
				<td>
				...
				<tr>
					<td class="alttext">
							<b>Résumé :</b>&#160;<xsl:apply-templates select="abstract"/>
					</td>
				</tr> <!--
				<tr>
				<td>
				...
				<tr>
				<td align="center">
					<p class="alttext">Aidez le développement par des donations avec votre carte de crédit !</p>
							<!-- Begin PayPal Logo -->
						...
						<input type="image" src="http://images.paypal.com/images/x-click-but21.gif" border="0" name="submit" alt="Payez via PayPal - c'est rapide, gratuit et sécurisé !"/>
						</form>
						<!-- End PayPal Logo -->
				</td>
				</tr>
...
<!--Netscape 4.7 hack end-->
		...
		Technologies, Inc.  Questions, Commentaires, Corrections ?  Email <a class="highlight"
		href="mailto:gentoo-dev@gentoo.org">gentoo-dev@gentoo.org</a>.
		Technologies, Inc.  Contacter les traducteurs ?  Email <a class="highlight"
		href="meekrob@gentoo.org">meekrob@gentoo.org</a>.
			</td>
		</tr> 
	</table>
</body>
...
User Docs:<br/>
			...
			<td width="1%" bgcolor="#dddaec" valign="top">
				...
				<tr>
				<td align="center" class="alttext">
					Mis à jour le <xsl:value-of select="/mainpage/date"/>
				</td>
				</tr>
				<tr>
				<td>
...
<xsl:template match="pre">
	...
	<xsl:choose>
		<xsl:when test="@caption">
			Exemple de code <xsl:value-of select="$prenum"/>: <xsl:value-of select="@caption" />
		</xsl:when>
		<xsl:otherwise>
			Exemple de code <xsl:value-of select="$prenum"/>
		</xsl:otherwise>
	</xsl:choose>
	</p>
	</td></tr>
